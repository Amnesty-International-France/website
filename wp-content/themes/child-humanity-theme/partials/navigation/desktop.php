...
?>
<header class="page-header height-header is-<?php echo esc_attr( $header_style ); ?>" role="banner" aria-label="<?php /* translators: [front] ARIA */ esc_attr_e( 'Page Header', 'amnesty' ); ?>">
	<div class="container">
        <div class="page-headerItems surheader">
           <nav class="page-nav page-nav--main2" aria-label="<?php /* translators: [front] ARIA */ esc_attr_e( 'Primary navigation', 'amnesty' );?>">
               <ul><?php amnesty_nav( 'main-menu-2' ); ?></ul>
           </nav>
        </div>
		<div class="page-headerItems mainheader">
		<?php amnesty_logo(); ?>
