...
{
    $clh_page = get_page_by_path('nous-connaitre/nos-combats/changez-leur-histoire/accueil-tunnel-clh');

    if ($clh_page instanceof WP_Post) {
        return $clh_page;
    }

    $clh_page = get_page_by_path('accueil-tunnel-clh');
...
function amnesty_get_clh_petition_tunnel_url(): string
{
    ...
    if ($clh_page) {
        ...
        return $clh_permalink ?: home_url('/nous-connaitre/nos-combats/changez-leur-histoire/accueil-tunnel-clh/');
    }

    return home_url('/nous-connaitre/nos-combats/changez-leur-histoire/accueil-tunnel-clh/');
}
