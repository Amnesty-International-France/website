...
add_action('init', function () {
	register_post_type('chronique', array(
		'labels' => array(
			...
			'edit_item' => 'Modifier Chronique',
			'view_item' => 'Voir Chronique',
			'view_items' => 'Voir Chroniques',
			'add_new_item' => 'Ajouter une Chronique',
			'add_new' => 'Ajouter une Chronique',
			'new_item' => 'Nouveau Chronique',
			'parent_item_colon' => 'Chronique parent :',
			'search_items' => 'Rechercher Chroniques',
			'not_found' => 'Aucun chroniques trouvé',
			'not_found_in_trash' => 'Aucun chroniques trouvé dans la corbeille',
			'archives' => 'Archives des Chronique',
			'attributes' => 'Attributs des Chronique',
			'insert_into_item' => 'Insérer dans chronique',
			'uploaded_to_this_item' => 'Téléversé sur ce chronique',
			'filter_items_list' => 'Filtrer la liste chroniques',
			'filter_by_date' => 'Filtrer chroniques par date',
			'items_list_navigation' => 'Navigation dans la liste Chroniques',
			...
			'item_link_description' => 'Un lien vers un chronique.',
		),
		'public' => true,
		'show_in_rest' => true,
