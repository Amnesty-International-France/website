    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'message' => 'Marque ce document privé (affichage dans "mon espace")',
                'default_value' => 0,
                'allow_in_bindings' => 0,
                'ui' => 1,
                'ui_on_text' => '',
            ...
            array(
                ...
                'conditional_logic' => array(
                    array(
                        array(
                            'field' => 'field_68c28ba807e0d',
                            'operator' => '==',
                            'value' => '1',
                        ),
                        array(
                            'field' => 'field_68c28ce407e0f',
                            'operator' => '==',
                            'value' => '',
                        ),
                    ),
            ...
            array(
                ...
                'choices' => array(
                    ...
                    'livret_daccompagnement' => 'Livret d’accompagnement',
                    'modeles' => 'Modèles',
                    'guide_militant' => 'Guide militant',
                    'materiel_militant' => 'Matériel militant',
                    'visuels' => 'Visuels',
                ),
                'default_value' => false,
                'return_format' => 'value',
...
add_action('manage_document_posts_custom_column', function ($column, $post_id) {
    if ($column === 'document_private') {
        echo get_field('field_68c28ba807e0d', $post_id) ? 'Oui' : 'Non';
    }
}, 10, 2);
