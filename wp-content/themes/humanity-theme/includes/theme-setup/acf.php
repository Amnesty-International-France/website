...
add_filter('acf/location/rule_values/page_slug', function (array $choices): array {
    $pages = get_pages([
...
add_filter('acf/location/rule_match/page_slug', function (bool $match, array $rule, array $screen): bool {
...
add_action(
    ...
    function () {
        ...
        acf_add_local_field_group(
            [
                'key' => 'group_696f94d698a8c',
                'title' => 'Hero changez leur histoire',
                'fields' => [
                    [
                        'key' => 'field_696f94d7b719f',
                        'label' => 'Titre du Hero',
                        'name' => 'change_their_history_hero_title',
                        'aria-label' => '',
                        'type' => 'text',
                        'instructions' => 'Saisissez le titre principal qui s\'affichera en haut de la page. Si laissé vide, le titre de la page sera utilisé par défaut',
                        'required' => 0,
                        'conditional_logic' => 0,
                        'wrapper' => [
                            'width' => '',
                    ...
                    [
                        'key' => 'field_696f9543b71a0',
                        'label' => 'Description du Hero',
                        'name' => 'change_their_history_hero_description',
                        'aria-label' => '',
                        'type' => 'text',
                        'instructions' => 'Saisissez le texte d\'introduction qui s\'affichera sous le titre.',
                        'required' => 0,
                        'conditional_logic' => 0,
                        'wrapper' => [
                            'width' => '',
                        ...
                        'default_value' => 'Description du hero',
                        'maxlength' => '',
                        'allow_in_bindings' => 0,
                        'placeholder' => '',
                        'prepend' => '',
                    ...
                    [
                        'key' => 'field_697064ea0413b',
                        'label' => 'Label du bouton du Hero',
                        'name' => 'change_their_history_hero_button_label',
                        'aria-label' => '',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 0,
