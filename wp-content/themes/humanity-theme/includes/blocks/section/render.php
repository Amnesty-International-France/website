...
function render_section_block($attributes, $content) {
	...
	ob_start();
	?>
	<div class="wp-block-amnesty-core-section section-block <?php echo esc_attr($sectionSize) . ' ' . esc_attr($backgroundColor) ?> <?php if($fullWidth) { echo esc_attr('full-width'); } ?>">
