...
new Taxonomy_Document_Militant_Types();

/**
 * Register the Document Militant Type taxonomy
 *
 * @package Amnesty\Taxonomies
 */
class Taxonomy_Document_Militant_Types extends Taxonomy
{
    /**
     * Taxonomy slug
     *
     * @var string
     */
    protected $name = 'document_militant_type';
     ...
     * @var string
     */
    protected $slug = 'document_militant_type';
    ...
    public static function labels(bool $defaults = false): object
    {
        $default_labels = [
            /* translators: [admin] */
            'name'                  => _x('Types de documents militant', 'taxonomy general name', 'amnesty'),
            /* translators: [admin] */
            'singular_name'         => _x('Type de document militant', 'taxonomy singular name', 'amnesty'),
            /* translators: [admin] */
            'search_items'          => __('Rechercher des types militant', 'amnesty'),
            /* translators: [admin] */
            'all_items'             => __('Tous les types militant', 'amnesty'),
            /* translators: [admin] */
            'parent_item'           => __('Type militant parent', 'amnesty'),
            /* translators: [admin] */
            'parent_item_colon'     => __('Type militant parent:', 'amnesty'),
            /* translators: [admin] */
            'edit_item'             => __('Modifier le type militant', 'amnesty'),
            /* translators: [admin] */
            'view_item'             => __('Voir un type militant', 'amnesty'),
            /* translators: [admin] */
            'update_item'           => __('Mettre à jour le type militant', 'amnesty'),
            /* translators: [admin] */
            'add_new_item'          => __('Ajouter un nouveau type militant', 'amnesty'),
            /* translators: [admin] */
            'new_item_name'         => __('Nom du nouveau type militant', 'amnesty'),
            /* translators: [admin] */
            'add_or_remove_items'   => __('Ajouter ou enlever un type militant', 'amnesty'),
            /* translators: [admin] */
            'choose_from_most_used' => __('Choisir parmi les types militant les plus fréquentes', 'amnesty'),
            /* translators: [admin] */
            'not_found'             => __('Aucun type militant trouvé.', 'amnesty'),
            /* translators: [admin] */
            'no_terms'              => __('Aucun type militant', 'amnesty'),
            /* translators: [admin] */
            'items_list_navigation' => __('Navigation dans la liste des types militant', 'amnesty'),
            /* translators: [admin] */
            'items_list'            => __('Liste des types militant', 'amnesty'),
        ...
        if (! isset($options['document_militant_type_labels'][0])) {
            return (object) $default_labels;
        }

        $config_labels = [];

        foreach ($options['document_militant_type_labels'][0] as $key => $value) {
            $key = str_replace('document_militant_type_label_', '', $key);
