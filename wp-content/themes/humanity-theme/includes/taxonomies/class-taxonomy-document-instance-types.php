...
new Taxonomy_Document_Instance_Types();

/**
 * Register the Document Instance Type taxonomy
 *
 * @package Amnesty\Taxonomies
 */
class Taxonomy_Document_Instance_Types extends Taxonomy
{
    /**
     * Taxonomy slug
     *
     * @var string
     */
    protected $name = 'document_instance_type';
     ...
     * @var string
     */
    protected $slug = 'document_instance_type';
    ...
    public static function labels(bool $defaults = false): object
    {
        $default_labels = [
            /* translators: [admin] */
            'name'                  => _x('Types de documents instance', 'taxonomy general name', 'amnesty'),
            /* translators: [admin] */
            'singular_name'         => _x('Type de document instance', 'taxonomy singular name', 'amnesty'),
            /* translators: [admin] */
            'search_items'          => __('Rechercher des types instance', 'amnesty'),
            /* translators: [admin] */
            'all_items'             => __('Tous les types instance', 'amnesty'),
            /* translators: [admin] */
            'parent_item'           => __('Type instance parent', 'amnesty'),
            /* translators: [admin] */
            'parent_item_colon'     => __('Type instance parent:', 'amnesty'),
            /* translators: [admin] */
            'edit_item'             => __('Modifier le type instance', 'amnesty'),
            /* translators: [admin] */
            'view_item'             => __('Voir un type instance', 'amnesty'),
            /* translators: [admin] */
            'update_item'           => __('Mettre à jour le type instance', 'amnesty'),
            /* translators: [admin] */
            'add_new_item'          => __('Ajouter un nouveau type instance', 'amnesty'),
            /* translators: [admin] */
            'new_item_name'         => __('Nom du nouveau type instance', 'amnesty'),
            /* translators: [admin] */
            'add_or_remove_items'   => __('Ajouter ou enlever un type instance', 'amnesty'),
            /* translators: [admin] */
            'choose_from_most_used' => __('Choisir parmi les types instance les plus fréquentes', 'amnesty'),
            /* translators: [admin] */
            'not_found'             => __('Aucun type instance trouvé.', 'amnesty'),
            /* translators: [admin] */
            'no_terms'              => __('Aucun type instance', 'amnesty'),
            /* translators: [admin] */
            'items_list_navigation' => __('Navigation dans la liste des types instance', 'amnesty'),
            /* translators: [admin] */
            'items_list'            => __('Liste des types instance', 'amnesty'),
        ...
        if (! isset($options['document_instance_type_labels'][0])) {
            return (object) $default_labels;
        }

        $config_labels = [];

        foreach ($options['document_instance_type_labels'][0] as $key => $value) {
            $key = str_replace('document_instance_type_label_', '', $key);
