...
<head>
	...
	<img
		src="https://click.email.amnesty.fr/open.aspx?ffcb10-fe9216747c65017575-fe2d117574640d7f751078-fe8c13727763027972-ff6515717d-fe27107775650d74751076-ff311170756d&d=70247&bmt=0"
			...
			<table width="580px" align="center" cellPadding="0" cellSpacing="0" border="0" valign="top">
				...
				<tr>
					<td align="center">
						...
						<img
							alt="L&#x27;Hebdo - Chaque vendredi, l&#x27;essentiel de l&#x27;acutalité des droits humains"
							src="https://prismic-io.s3.amazonaws.com/lesbonneschoses-vg498smaaleapicq%2F0544d35b-01ef-448c-9f2f-62dd4d8669af_amnesty-mailing-hebdo-header.jpg"
							width="518" height="81"
					...
					<td>
						...
						foreach ($articles as $article):
							...
							<table align="center"
								...
								<tr>
									<td>
										<table width="100%" cellPadding="10" style="padding:0 10px" cellSpacing="0"
				...
				if (isset($_GET['get_source'])): ?>
					...
					<tr>
						<td align="center">
							<span
								style="font-family:Oswald, Arial, sans-serif;font-size:24px;line-height:14px;color:#000;font-style:normal;text-transform:uppercase;text-align:left">Donnez-nous les moyens d'agir</span>
							<div style="font-size:20px;height:20px;line-height:20px;mso-line-height-rule:exactly"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td align="center">
							<span
								style="font-family:Oswald, Arial, sans-serif;font-size:24px;line-height:14px;color:#000;font-style:normal;text-transform:uppercase;text-align:left">Grâce à vous, nous pouvons agir</span>
							<div style="font-size:20px;height:20px;line-height:20px;mso-line-height-rule:exactly"></div>
						</td>
					</tr>
					<tr>
				...
				<tr>
					<td style="background-color:black;padding:20px 70px">
						<table cellPadding="0" cellSpacing="0" border="0" align="left" valign="top">
							...
							<tr>
								<td>
									<table width="100%" style="padding:0 10px" cellPadding="0" cellSpacing="0"
										   border="0" align="left" valign="top">
										<tbody>
										<tr>
											<td width="170"><img alt="Logo Amnesty Internalional France"
																 src="https://prismic-io.s3.amazonaws.com/lesbonneschoses-vg498smaaleapicq%2F7a711500-38f3-4d70-98a6-23e9aee71712_logo_blanc-noir.jpeg"
																 width="151"
																 style="display:block;outline:none;border:none;text-decoration:none"/>
											</td>
											<td vAlign="middle">
												<table cellPadding="5" cellSpacing="0" border="0" align="left"
													...
													<tr>
														<td><span
																style="font-family:sans-serif;font-size:14px;line-height:14px;color:#989898">Nous suivre:</span>
														</td>
														<td><img alt="facebook"
																 src="https://prismic-io.s3.amazonaws.com/lesbonneschoses-vg498smaaleapicq%2Fceedb361-b2a3-4c74-ae60-9ad38217f946_fb.png"
																 width="36" height="36"
																 style="display:block;outline:none;border:none;text-decoration:none"/>
														</td>
														<td>
															<img alt="twitter"
																 src="https://prismic-io.s3.amazonaws.com/lesbonneschoses-vg498smaaleapicq%2Fb5386c48-07b9-44c4-a9b2-d63ae4e82111_tw.png"
																 width="36" height="36"
																 style="display:block;outline:none;border:none;text-decoration:none"/>
														</td>
														<td><img alt="youtube"
																 src="https://prismic-io.s3.amazonaws.com/lesbonneschoses-vg498smaaleapicq%2F2bdcaaaf-33fb-4648-829b-551449590b76_yt.png"
																 width="36" height="36"
																 style="display:block;outline:none;border:none;text-decoration:none"/>
														</td>
														<td>
															<img alt="instagram"
																 src="https://images.prismic.io/amnestyfr/6c60d5fa-2d61-488d-8b30-f19b02b852ae_instagram.png?auto=compress,format&amp;w=36&amp;h=36"
																 width="36" height="36"
																 style="display:block;outline:none;border:none;text-decoration:none"/>
														</td>
													</tr>
									...
									<table cellPadding="0" cellSpacing="0" border="0" align="left" valign="top">
										...
										<tr>
											<td>
												<div
													style="font-size:20px;height:20px;line-height:20px;mso-line-height-rule:exactly"></div>
												<p style="text-align:center;color:#989898;font-size:11px;line-height:14px">
													Confidentialité des données : Conformément à la loi française
													(article 27 de la loi n°78-17 du 6 janvier 1978 relative à l&#x27;informatique,
													aux fichiers et aux libertés), vous disposez, en vous adressant au
													Siège d&#x27;Amnesty International, d&#x27;un droit d&#x27;accès, de
													rectification et d&#x27;opposition aux informations vous concernant.
													Si vous ne souhaitez plus recevoir d&#x27;e-mails de ce type, vous
													pouvez <a href="%%=CloudPagesURL(3321)=%%" target="_blank"
															  rel="noopener noreferrer"
															  style="color:#989898;text-decoration:underline">vous
														désinscrire</a>.</p>
											</td>
										</tr>
										</tbody>
