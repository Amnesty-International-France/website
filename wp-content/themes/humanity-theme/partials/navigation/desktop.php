...
?>
<header class="page-header is-<?php echo esc_attr($header_style); ?>" role="banner" aria-label="<?php esc_attr_e('Page Header', 'amnesty'); ?>">
	<div class="container--full-width">
		<div class="page-headerItems top-header">
			<nav class="page-nav page-nav--top-main" aria-label="<?php esc_attr_e('Primary navigation top', 'amnesty'); ?>">
				<ul>
					<li>
						<a href="#"
		...
		<div class="page-headerItems main-header">
			<div class="main-header-mobile">
				...
				<div class="donate-button-mobile">
					<a href="https://soutenir.amnesty.fr/b?cid=66&reserved_originecode=WBF01W1012&amount=1500&frequency=regular" class="link" data-gtm="clic_cta" data-name="faire un don" data-position="header">
			...
			<div class="donate-button-desktop">
				<a class="link" href="https://soutenir.amnesty.fr/b?cid=66&reserved_originecode=WBF01W1012&amount=1500&frequency=regular" data-gtm="clic_cta" data-name="faire un don" data-position="header">
