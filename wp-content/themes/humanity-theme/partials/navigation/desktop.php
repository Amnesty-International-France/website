...
<header class="page-header is-<?php echo esc_attr($header_style); ?>" role="banner"
        aria-label="<?php esc_attr_e('Page Header', 'amnesty'); ?>">
	<div class="container--full-width">
		<div class="page-headerItems top-header">
			<nav class="page-nav page-nav--top-main"
			     aria-label="<?php esc_attr_e('Primary navigation top', 'amnesty'); ?>">
				<ul>
					<li>
						<a href="#"
					...
					<li>
						<a href="/mon-espace" class="menu-item menu-user" aria-current="page" target="_blank"
		...
		<div class="page-headerItems main-header">
			<div class="main-header-mobile">
				...
				<div class="donate-button-mobile">
					<a href="https://soutenir.amnesty.fr/b?cid=66&reserved_originecode=WBF01W1012&amount=1500&frequency=regular"
					   class="link" data-gtm="clic_cta" data-name="faire un don" data-position="header">
			...
			<nav class="page-nav page-nav--main" aria-label="<?php esc_attr_e('Primary navigation', 'amnesty'); ?>">
				<ul class="desktop-nav">
					<?php amnesty_nav('main-menu', new Desktop_Nav_Walker()); ?>
					<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children donate-link">
						<div class="donate-button-desktop">
							<a class="link"
							   href="https://soutenir.amnesty.fr/b?cid=66&reserved_originecode=WBF01W1012&amount=1500&frequency=regular"
							   data-gtm="clic_cta" data-name="faire un don" data-position="header">
								<svg viewBox="0 0 18 14" version="1.1" xmlns="http://www.w3.org/2000/svg"
									...
									<g id="HeartIcon" fill="currentColor" fill-rule="nonzero">
										...
										<g class="icon-heart-full" stroke="none" stroke-width="1" fill-rule="evenodd"
										   fill="none">
											<path
												d="M16.19,1.155 C14.518,-0.379 11.807,-0.379 10.135,1.155 L9,2.197 L7.864,1.155 C6.192,-0.379 3.482,-0.379 1.81,1.155 C-0.071,2.882 -0.071,5.675 1.81,7.401 L9,14 L16.19,7.401 C18.07,5.675 18.07,2.881 16.19,1.155 Z"
												id="Path"></path>
										</g>
									</g>
								</svg>
			...
			<div class="main-header-mobile-buttons">
				...
				<nav class="page-nav page-nav--main" aria-label="<?php esc_attr_e('Primary navigation', 'amnesty'); ?>">
					<button
						...
						aria-label="<?php esc_attr_e('Open navigation', 'amnesty'); ?>"
					>
