...
?>
<div class="checkboxGroup is-nav <?php echo esc_attr($params['class']); ?>" action="<?php echo esc_url(current_url()); ?>">
...
?>
	...
	<?php foreach ($params['options'] as $value => $item_label) : ?>
		<span class="checkboxGroup-item">
			<input id="<?php echo esc_attr($make_id($value)); ?>" type="radio" name="<?php echo esc_attr($params['name']); ?>" <?php checked($item_label, $params['active']); ?>>
