...
aif_include_partial('info-message', [
    ...
    'content' => "Votre email sert d’identifiant pour votre compte Espace donateur. Pour le modifier, <a class='aif-link--secondary' href='{$url}'>contactez-nous </a>."]); ?>
				...
				<input placeholder="Ville" autocomplete="address-level3" name="Ville__c" class="aif-input" id="city" type="text" value="<?php echo esc_attr($sf_user->Ville__c); ?>" />
...
?>
		...
		<section class="aif-container--form">
			...
			<?php aif_include_partial('alert', ['content' => "Prélèvement automatique sur l'IBAN se terminant par ". esc_html($last4IBANDigit)]); ?>
