        ...
        <form class="form" id="legsForm" action="" method="POST">
          ...
          <div class="form-row">
              <div class="form-group">
                <input type="text" id="last_name" name="last_name" value="<?php echo esc_attr($lastName); ?>" placeholder="Nom *">
                <div id="error-last_name" class="error-message-container"></div>
              </div>

              <div class="form-group">
                <input type="text" id="first_name" name="first_name" value="<?php echo esc_attr($firstName); ?>" placeholder="Prénom *">
                <div id="error-first_name" class="error-message-container"></div>
              </div>
          </div>

          <div class="form-group">
            <input type="text" id="address" name="address" value="<?php echo esc_attr($address); ?>" placeholder="Adresse *">
            <div id="error-address" class="error-message-container"></div>
          </div>

          <div class="form-row">
            <div class="form-group">
              <input type="text" id="zip_code" name="zip_code" value="<?php echo esc_attr($zipCode); ?>" placeholder="Code Postal *" pattern="\d{5}" title="Veuillez entrer un code postal de 5 chiffres.">
              <div id="error-zip_code" class="error-message-container"></div>
            </div>

            <div class="form-group">
              <input type="text" id="city" name="city" value="<?php echo esc_attr($city); ?>" placeholder="Ville *">
          ...
          <div class="form-row">
            <div class="form-group">
              <input type="email" id="email" name="email" value="<?php echo esc_attr($email); ?>" placeholder="Email *">
              <div id="error-email" class="error-message-container"></div>
            </div>

            <div class="form-group">
              <input type="tel" id="phone" name="phone" value="<?php echo esc_attr($phone); ?>" placeholder="Téléphone">
          ...
          <div class="form-group">
            <div class="receive-by">
              <input type="checkbox" id="receive_by_mail" name="receive_by_mail" <?php echo ($receiveByMail ? 'checked' : ''); ?>>
              <label for="receive_by_mail">Par courrier postal</label>
              <input type="checkbox" id="receive_by_email" name="receive_by_email" <?php echo ($receiveByEmail ? 'checked' : ''); ?>>
