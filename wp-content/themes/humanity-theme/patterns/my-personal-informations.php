...
/**
 * Title: Mes informations personnelles Pattern
 * Description: Mes informations personnelles 
 * Slug: amnesty/my-personal-informations
 * Inserter: no
 */
...
<main class="aif-donor-space-content">
    ...
    <section class="aif-container--form">
        ...
        <?php else : ?>
            <p><?= "Vous êtes <span class='aif-text-bold aif-uppercase'> {$user_status} </span> d’Amnesty International France sous le numéro : {$sf_user->Identifiant_contact__c}" ?></p>
        <?php endif ?>
        ...
        <form class="" onsubmit="disablePersonalInformationsButtons()" role="form" method="POST" action="">
            ...
            <input placeholder="Ville" autocomplete="address-level3" name="Ville__c" class="aif-input" id="city" type="text" value="<?= $sf_user->Ville__c ?>" />
            ...
            <button class="btn aif-mt1w aif-button--full" onclick="this.form.submit(); this.disabled=true;" type="submit">Transmettre les modifications</button>
    ...
    <section class="aif-container--form">
        ...
        <p>
            <a href="/mon-espace/mes-dons/modification-coordonnees-bancaire" class="btn btn--white  aif-button--full">Modifier l'IBAN</a>
        </p>
    </section>
    <?php endif ?>
</main>
