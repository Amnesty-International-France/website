...
<section class="wp-block-group single-chronicle__content container has-gutter">
	<!-- wp:columns {"className":"single-chronicle-content__columns"} -->
		...
		<aside class="single-chronicle__content__aside u-sticky">
			...
			<?php endif; ?>
			<!-- wp:amnesty-core/button {"label":"Abonnez-vous pour 3€/mois","size":"medium","icon":"arrow-right","linkType":"external","externalUrl":"https://soutenir.amnesty.fr/b?cid=365&lang=fr_FR&reserved_originecode=null"} /-->
			<!-- wp:amnesty-core/button {"label":"Voir les anciens numéros","size":"small","icon":"arrow-right","style":"bg-white outline-black","linkType":"internal","postId":"1"} /-->
		</aside>
		<!-- /wp:column -->
