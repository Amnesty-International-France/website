...
if ($is_thank_you_page && is_singular('petition')) {
	...
	<div class="wp-block-group container petition-container has-gutter">
		<div class="petition-layout">
			<div class="petition-main">
				<!-- wp:group {"tagName":"page","className":"article <?php
				...
				<article class="wp-block-group article">
					...
					<section class="wp-block-group article-content">
						...
						<div class="petition-content">
							<div class="infos">
								<p class="end-date">Jusqu&apos;au <?php
                                    echo esc_html($formatted_end_date); ?></p>
								<div class="progress-bar-container">
									<div class="progress-bar" style="width: <?php
                                    echo esc_attr($progress_percentage); ?>%;"></div>
								</div>
								<p class="supports">
									<span class="current-signatures"><?php
                                        echo esc_html($current_signatures); ?></span>
									<?php
    ...
    ?>.
									<span class="help-us">Aidez-nous à atteindre <?php
        echo esc_html($signatures_target); ?></span>
								</p>
							</div>
						</div>
						<!-- wp:post-content /-->
                        ...
                        if ($type === 'petition') : ?>
							<div class="read-more-block">
								<div class="read-more-toggle"
									 data-read-more-label="<?php
     echo esc_attr($read_more_label); ?>">
    ...
    echo $letter; ?>
                            ...
                            if (!empty($pdf_url)) : ?>
								<p class="printable-petition-link">
									<a href="<?php
    echo esc_url($pdf_url); ?>" target="_blank" rel="noopener">Téléchargez la version
										imprimable</a> et faites-la signer autour de vous.
								</p>
							<?php
                            endif; ?>
						<?php
