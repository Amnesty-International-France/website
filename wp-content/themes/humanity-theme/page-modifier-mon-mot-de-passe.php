...
?>
				...
				<div class="aif-password-container">
					<label class="aif-password-container__label" for="password">Nouveau mot de passe
						(obligatoire)</label>
					<div class="aif-password-container__input-wrapper">
						<input class="aif-password-container__input aif-input" name="confirm-password"
						       aria-describedby="passwordHelp passphraseRequirements" type="password"
						       id="confirm-password"
					...
					<div id="password-error-not-match" class="aif-text-red aif-hide">Les mots de passe ne correspondent
						pas.
					</div>
